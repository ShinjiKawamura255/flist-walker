...
- Review Notes: Review completed on 2026-04-08. The slice stays distinct from Slice B because it focuses on protocol/module boundaries rather than background tab result-flow ownership, and it stays distinct from Slice D because it does not pull command-oriented test restructuring into scope.
...
- [ ] Map protocol groups and their consumers inside the current worker modules
- [ ] Extract narrower protocol-oriented module(s)
- [ ] Update imports and tests without changing worker behavior
