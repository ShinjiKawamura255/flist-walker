...
- [x] P-005 preview/highlight/cache の責務整理と module 分離
...
- 2026-04-01 00:00 Phase 3 completed. Moved preview/highlight/cache helpers from `rust/src/app.rs` to `rust/src/app/cache.rs` and verified with `cargo test --locked`.
