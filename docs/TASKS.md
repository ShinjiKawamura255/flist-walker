...
- Current active engineering change plan: `docs/EXECUTION-PLAN-20260425-slice-b-self-update-staging-hardening.md` (completed; next Slice C plan not yet created)
