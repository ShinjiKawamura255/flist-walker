...
| TC-183 | unit | index/search の batch/replace/finish/fail/cancel と stale/out-of-order completion を sequence 中へ挿入しても closed tab または別 tab を変更せず、quiescence は固定 step 以内に pending/in-flight/routing/progress state を解放する | SP-022 |
