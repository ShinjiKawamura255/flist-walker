...
| VM-006 | CI coverage gate / GUI validation docs | Create `target/llvm-cov`, then run `cargo llvm-cov --locked --workspace --lcov --output-path target/llvm-cov/lcov.info --fail-under-lines 75` | Re-measure and update baseline when raising threshold. |
...
| Self-update | SP-014, DES-014 | Sections 6.13, 8.5, 10 | TC-074 through TC-081, TC-086, TC-096 through TC-098, TC-100, TC-117, TC-119, TC-157 through TC-160, TC-169, TC-171 |
