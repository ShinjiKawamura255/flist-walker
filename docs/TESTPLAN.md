...
| VM-002 App/UI orchestration | `rust/src/app.rs`, `rust/src/app/*.rs` の state/render/input/session/update/filelist 変更 | `cd rust && cargo test` | dialog / focus / tab 操作を変えた場合は GUI 手動試験 |
