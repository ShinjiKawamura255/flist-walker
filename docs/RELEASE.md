...
- 現行の shipped capability table には v0.24.3、v0.24.4、v0.24.5、v0.25.0、v0.25.1、v0.26.0、v0.27.0 を明示登録し、各リリースの exact 26-entry candidate manifest を対応する predecessor contract で検証する。
