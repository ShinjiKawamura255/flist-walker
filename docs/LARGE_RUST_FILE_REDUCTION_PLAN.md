...
- Next recommended slice: Slice D or remaining Slice E candidates (`runtime_config.rs`, `app/session.rs`) before the higher-risk index worker/render panel split.
