...
- 実装: `rust/src/app/coordinator.rs`, `rust/src/app/input/actions.rs`, `rust/src/app/shell_support.rs`, `rust/src/app/worker_protocol.rs`, `rust/src/app/worker_tasks.rs`, `rust/src/actions.rs`
...
- 役割補足: `trace helper` では `app/mod.rs` が opt-in window trace の入口だけを保持し、worker trace は `app/worker_tasks.rs` の実装 body と `app/worker_protocol.rs`、session/window 永続化まわりの補助 trace は `app/session.rs` など各 owner helper へ分離する。
...
- 役割補足: action authorization policy は `actions.rs`、worker の共有 action notice formatting は `app/worker_tasks.rs` が直接所有し、re-export 専用の中間 module を置かない。
...
- 実装: `rust/src/app/mod.rs`, `rust/src/app/render.rs`, `rust/src/app/cache.rs`, `rust/src/app/worker_tasks.rs`, `rust/src/app/state.rs`, `rust/src/app/pipeline.rs`
...
- 実装: `rust/src/updater.rs`, `rust/src/updater/release.rs`, `rust/src/updater/staging.rs`, `rust/src/updater/manifest.rs`, `rust/src/updater/apply.rs`, `rust/src/updater/transaction.rs`, `rust/src/updater/transaction/model.rs`, `rust/src/updater/transaction/filesystem.rs`, `rust/src/updater/transaction/platform.rs`, `rust/src/main.rs`, `rust/src/app/update.rs`, `rust/src/app/render.rs`, `rust/src/app/worker_tasks.rs`, `rust/src/app/state.rs`
...
- 実装: `rust/src/app/worker_tasks.rs`, `rust/src/app/index_worker.rs`, `rust/src/app/mod.rs`, `rust/src/app/session.rs`, `rust/src/app/input/mod.rs`, `rust/src/main.rs`
