...
fn runtime_sort_mode(value: PresetSortMode) -> ResultSortMode {
    match value {
        ...
        PresetSortMode::PathAsc => ResultSortMode::PathAsc,
        PresetSortMode::PathDesc => ResultSortMode::PathDesc,
...
fn preset_sort_mode(value: ResultSortMode) -> PresetSortMode {
    match value {
        ...
        ResultSortMode::PathAsc => PresetSortMode::PathAsc,
        ResultSortMode::PathDesc => PresetSortMode::PathDesc,
