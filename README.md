...
- `Ctrl+Shift+P`: open the preset picker, also available from `Presets...`; fuzzy-filter names, apply with `Enter`, add the current search, edit with `F2`, or delete the selected preset (`Cmd+Shift+P` on macOS)
