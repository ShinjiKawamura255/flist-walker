...
- For `architecture-debt-closure`, read `docs/CHANGE-PLAN-20260408-architecture-debt-closure-roadmap.md`, `docs/CHANGE-PLAN-20260408-architecture-debt-closure-slice.md`, and `docs/CHANGE-PLAN-20260408-architecture-debt-closure-updater-subslice.md` in that order before starting implementation.
- Execute the debt closure work in the documented roadmap, slice, and subslice order unless one of those plans is updated first.
