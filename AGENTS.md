...
- `app-architecture-roadmap` では、実装前に `docs/CHANGE-PLAN-20260408-app-architecture-roadmap.md` を読み、その後 `docs/CHANGE-PLAN-20260409-command-oriented-app-tests-slice.md` を読むこと。
