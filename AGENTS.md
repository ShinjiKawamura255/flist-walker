...
- `review-followups` では [docs/CHANGE-PLAN-20260401-review-followups.md](/mnt/d/work/flistwalker/docs/CHANGE-PLAN-20260401-review-followups.md) を実装前に読むこと。
- 実装順は change plan に従い、順序・スコープ・リスクが変わる場合は先に change plan を更新すること。
- この改善計画の完了後は、この一時セクションを `AGENTS.md` から削除し、恒久的な内容だけを docs へ残すこと。
