...
- For `architecture-debt-closure`, read `docs/CHANGE-PLAN-20260408-architecture-debt-closure-roadmap.md` and `docs/CHANGE-PLAN-20260408-architecture-debt-closure-perf-gate-slice.md` in that order before starting implementation.
